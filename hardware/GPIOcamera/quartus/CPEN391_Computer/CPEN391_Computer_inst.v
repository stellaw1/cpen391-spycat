	CPEN391_Computer u0 (
		...
		.vid_pp_out_export                 (<connected-to-vid_pp_out_export>),                 //              vid_pp_out.export
		...
		.new_sdram_controller_0_addr       (<connected-to-new_sdram_controller_0_addr>),       //  new_sdram_controller_0.addr
		.new_sdram_controller_0_ba         (<connected-to-new_sdram_controller_0_ba>),         //                        .ba
		.new_sdram_controller_0_cas_n      (<connected-to-new_sdram_controller_0_cas_n>),      //                        .cas_n
		.new_sdram_controller_0_cke        (<connected-to-new_sdram_controller_0_cke>),        //                        .cke
		.new_sdram_controller_0_cs_n       (<connected-to-new_sdram_controller_0_cs_n>),       //                        .cs_n
		.new_sdram_controller_0_dq         (<connected-to-new_sdram_controller_0_dq>),         //                        .dq
		.new_sdram_controller_0_dqm        (<connected-to-new_sdram_controller_0_dqm>),        //                        .dqm
		.new_sdram_controller_0_ras_n      (<connected-to-new_sdram_controller_0_ras_n>),      //                        .ras_n
		.new_sdram_controller_0_we_n       (<connected-to-new_sdram_controller_0_we_n>),       //                        .we_n
		.sdram_clk_1_clk                   (<connected-to-sdram_clk_1_clk>),                   //             sdram_clk_1.clk
		.sdram_pll_locked_export           (<connected-to-sdram_pll_locked_export>),           //        sdram_pll_locked.export
		.sdram_pll_refclk_clk              (<connected-to-sdram_pll_refclk_clk>)               //        sdram_pll_refclk.clk
	);
